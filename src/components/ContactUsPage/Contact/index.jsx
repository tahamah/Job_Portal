      ...
      <div className='w-1/2 '>
        <form className=' shadow-xl max-w-md bg-slate-50 p-8 -mt-28 z-10'>
          ...
          <div class='my-6'>
            <input
              type='text'
              class='shadow-sm bg-gray-50 border-4 border-gray-300 text-gray-900 text-sm  focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light'
          ...
          <div class='mb-6'>
            <textarea
              rows='4'
              class='block p-2.5 w-full text-sm text-gray-900 bg-gray-50  border-4 border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'
