      ...
      <section className='mt-10 mx-10 md:flex justify-between gap-20 items-start'>
        <div className='md:w-2/3'>
          ...
          <p className=' leading-8'>
            ...
            commodi molestiae labore expedita. Ducimus cumque culpa veniam quam
            aliquid dolorem, eius autem laboriosam voluptates hic earum sapiente
            dolore unde nisi aliquam, quas esse ut soluta? Aut aliquid, pariatur
            rem, tempore illo ratione culpa illum doloremque, sed exercitationem
            nemo id adipisci iure quas laboriosam ea vero. Quia praesentium
            tempore cumque veniam.
          </p>
